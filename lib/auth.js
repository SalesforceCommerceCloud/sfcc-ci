...
var accountManagerPath = '/dw/oauth2/access_token';
var accountManagerHost = 'account.demandware.com';

function obtainToken(basicEncoded, callback) {
    // just do the request with the basicEncoded and call the callback
    request
        .post('https://' + accountManagerHost + accountManagerPath)
...
function auth(client, client_secret, auto_renew, accountManagerHostOverride) {
