...
module.exports.api = {
     ...
     * @param {Function} success Callback function executed when the authentication succeeded. The token will be passed as only parameter to the success callback.
     * @param {Function} error Callback function executed when the authentication failed. The error will be passed as only parameter to the error callback.
