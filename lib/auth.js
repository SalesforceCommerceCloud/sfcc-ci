...
module.exports.api = {
     ...
     * @param {Boolean} auto_renew Controls whether the authentication should be automatically renewed once the token expires.
     ...
     */
    auth : function (client_id, client_secret, auto_renew, callback) {
        // check parameters
        ...
        if (typeof(auto_renew) !== 'boolean') {
            throw new TypeError('Parameter renew missing or not of type Boolean');
        }
