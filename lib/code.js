...
module.exports.api = {
     ...
     * @param {Function} success (Optional) Callback function executed when the code activation succeeded.
     * @param {Function} error (Optional) Callback function executed when the code activation failed. The error will be passed as only parameter to the error callback.
