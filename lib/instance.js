...
module.exports.api = {
    ...
    /**
     * Adds a new Commerce Cloud instance to the list of configured instances
     *
     * @param {String} instance Instance to start the import on
     * @param {String} alias (Optional) The alias used in place of the instance name
     * @param {Function} callback Callback function executed as a result. The job execution details and the error will be passed as parameters to the callback function.
     */
    add: function(instance, alias, callback) {
        // attempt to reach the instance
        request
            .get('https://' + instance + ENDPOINT_META)
            .end(function (err, res) {
    ...
    /**
     * Returns the instance related to the given alias or host
     * If nothing found, returns undefined
     *
     * @param {String} aliasOrHost Alias or host used to find the instance details
     *
