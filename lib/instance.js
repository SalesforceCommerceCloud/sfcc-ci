...
function lookupInstance(aliasOrHost) {
    ...
    let foundInstance = all.find(instance => (instance.alias === aliasOrHost || instance.host === aliasOrHost));
    if (foundInstance) {
        return foundInstance.host;
    }
    return null;
...
module.exports.config = {
     ...
     * @return {Promise} returns resolved, when host is successfully set as default; otherwise returns reject
     */
    setDefault : function(aliasOrHost) {
        ...
        if (host) {
            ...
            return new Promise(function(resolve, reject) {
                reject(new Error('Cannot set unknown "' + aliasOrHost + '" as default instance.'));
            });
        }
