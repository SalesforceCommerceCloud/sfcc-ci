...
function setInstance(instance) {
    ...
    console.log('Instance %s set as default.', instance);
}
...
function addInstance(instance, alias) {
    ...
    if (alias) {
        ...
        if ( aliasDuplicates.length > 0 ) {
            ...
            console.log('Alias "%s" already in use. Alias reset and set for new instance %s.', alias, instance);
        }
    }
