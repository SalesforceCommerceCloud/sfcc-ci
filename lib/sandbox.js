...
function doCookieRegistration(link) {
    ...
    printInboundIPs();
    (async() => {
        await askQuestion('Please point the domain in your etc/hosts to one of these IPs and set the alias in your ' +
            'instance\'s site alias configuration (see Merchant Tools > SEO > Aliases). Press <Enter> when ready:');
        open(link)
    })();
}
