...
function sandboxCreateAsync(newSandboxResponse, callback) {
    ...
    poller.start(() => {
        getSandbox(newSandboxResponse.id, null, function(err, sandbox) {
            ...
            // no error occured
            if (Object.keys(pollResultStep).length === 0) {
