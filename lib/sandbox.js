...
module.exports.api = {
    ...
    get : function(spec, asJson, hostOnly, openBrowser, topic, callback) {
        var foundSandbox = null;

        // id not provided, using other properties to lookup sandbox
        if ( !( spec['id'] || ( spec['realm'] && spec['instance'] ) ) ) {
            if (typeof callback === 'function') {
                callback('Provide either an id or a realm and an instance of the sandbox.', null);
                return;
            }
            console.error('Provide either an id or a realm and an instance of the sandbox.');
            return;
    ...
    create : function(realm, alias, ttl, asJson, sync, setAsDefault, callback) {
     ...
     */
    list : function(asJson, sortBy, callback) {
        getAllSandboxes(function(err, list) {
            if (err) {
                console.error(err.message);
                return;
...
module.exports.cli = {
    ...
    list : function(asJson, sortBy) {
        exports.api.list(asJson, sortBy);
    },
    ...
    create : function(realm, alias, ttl, asJson, sync, setAsDefault) {
        exports.api.create(realm, alias, ttl, asJson, sync, setAsDefault)
    },
    ...
    get : function(spec, asJson, hostOnly, openBrowser, topic) {
        ...
        exports.api.get(spec, asJson, hostOnly, openBrowser, topic);
    },
