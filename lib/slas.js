        ...
        tenant: {
            create: async ({ shortcode, tenant, file, json }) => {
                ...
                try {
                    ...
                    handleCLIError("Could not create tenant: ", e.message, json);
                }
            },
        ...
        client: {
            create: async ({ shortcode, tenant, client, file }) => {
                ...
                try {
                    ...
                    handleCLIError("Could not create client: ", e.message, true);
                }
            },
            list: async ({ shortcode, tenant, client, json }) => {
                ...
                if (client) {
                    try {
                        ...
                        return handleCLIError("Could not get client: ", e.message);
                    }
                }
