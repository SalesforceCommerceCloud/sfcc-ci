...
function deployCodePromise(instance, archive, token, options) {
    return new Promise((resolve, reject) => {
        deployCodeAPI(instance, archive, token, options, err => {
            if (err) {
                reject(err);
            } else {
                resolve();
...
module.exports.deployCodePromise = deployCodePromise;
